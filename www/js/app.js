...
(function(){
  ...
  app.controller('menuController', [ '$http', '$scope', '$rootScope', function($http, $scope, $rootScope){
    ...
    $scope.menuAPI = 'http://gumig.com/hyderabadbus/api/get_category_index';
    $scope.menuItems = [];
  ...
  app.controller('categoryController', [ '$http', '$scope', '$rootScope', function($http, $scope, $rootScope){
    ...
    $scope.catAPI = 'http://gumig.com/hyderabadbus/api/get_category_posts/?id='+$scope.categoryID;
    $scope.catItems = [];
  ...
  app.controller('newsController', [ '$http', '$scope', '$rootScope', function($http, $scope, $rootScope){
    ...
    $scope.yourAPI = 'http://gumig.com/hyderabadbus/api/get_recent_posts';
    $scope.items = [];
    $scope.totalPages = 0;
    $scope.currentPage = 1;
    $scope.pageNumber = 1;
